...
public class Test_SingleMany2One {
	...
	public void testSave() {
		...
		c1.setCustomerName("li4");

		Order o1 = new Order();
		o1.setOrderName("JD001");
//		o1.setCustomer(c1);

		Order o2 = new Order();
		o2.setOrderName("JD002");
//		o2.setCustomer(c1);

		/*
		 * 先N后1，三条insert+2条update，性能不好 entityManager.persist(o1);
		 * entityManager.persist(o2); entityManager.persist(c1);
		 */
