 ...
 *	2.借助params拦截器给bookId赋值，但此时prepare拦截器前面没有params拦截器
 *	3.需要在prepare拦截器前面插入params拦截器
 *	4.将当前默认的拦截器栈设置为：paramsPrepareParamsStack
 */
public class CopyOfBookAction06 implements RequestAware,ModelDriven<Book>,Preparable{
