...
public class MultiUploadAction01 extends ActionSupport implements ServletContextAware{
	...
	public String execute() throws IOException {
		...
		System.out.println("facePicture.name="+facePicture.getName());
		System.out.println("facePictureContentType="+facePictureContentType);
